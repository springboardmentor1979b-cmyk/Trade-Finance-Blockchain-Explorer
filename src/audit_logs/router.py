...
from .schemas import AuditLogCreate, AuditLogListResponse, AuditLogResponse
...
def get_all_audit_logs(
    ...
    Returns a paginated list of audit logs in the system, optionally filtered
    ...
    """
    logs, total = AuditLogService.get_all_audit_logs(
        db,
        skip=skip,
        limit=limit,
        search=search,
    ...
    return AuditLogListResponse(total=total, logs=logs, skip=skip, limit=limit)
