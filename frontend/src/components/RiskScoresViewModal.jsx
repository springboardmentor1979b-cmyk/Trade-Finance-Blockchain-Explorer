        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <div className="bg-slate-800 rounded-xl border border-white/10 max-w-md w-full p-6">
                <div className="flex items-center justify-between mb-4">
                    <h2 className="text-xl font-bold text-white">Risk Score Details</h2>
                    <button
                        onClick={onClose}
                ...
                <div className="space-y-4">
                    ...
                    <div className="p-3 bg-white/5 rounded-lg border border-white/10">
                        ...
                        <p className="text-white font-medium mt-1">{riskScore.user_name}</p>
                    </div>

                    <div className="p-3 bg-white/5 rounded-lg border border-white/10">
                        <p className="text-sm text-slate-400">Category</p>
                        <p className="text-white font-medium mt-1">{riskScore.category}</p>
                    </div>

                    <div className="p-3 bg-white/5 rounded-lg border border-white/10">
                        <p className="text-sm text-slate-400">Score</p>
                        <p className="text-white font-medium mt-1">{riskScore.score}</p>
                    </div>

                    <div className="p-3 bg-white/5 rounded-lg border border-white/10">
                        <p className="text-sm text-slate-400">Rationale</p>
                        <p className="text-white font-medium mt-1">{riskScore.rationale}</p>
                    </div>
